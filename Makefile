...
test-up:
	...
	docker-compose --project-name search-service-test run --rm wait-for-it -address=http://search-service.eu-west-1.es.localhost.localstack.cloud:4566 --timeout=30
